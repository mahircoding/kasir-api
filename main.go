...
func main() {
	...
	http.HandleFunc("/api/categories/", categoryHandler.Handle)
	http.HandleFunc("/api/checkout", transactionHandler.Handle)
	http.HandleFunc("/api/checkout/", transactionHandler.Handle)
	...
	fmt.Println("\nCheckout:")
	fmt.Println("  GET    /api/checkout     - List all transactions")
	fmt.Println("  GET    /api/checkout/{id} - Get transaction by ID")
	fmt.Println("  POST   /api/checkout     - Create new transaction")
	fmt.Println("  DELETE /api/checkout/{id} - Delete transaction")
	fmt.Println("\nReport:")
